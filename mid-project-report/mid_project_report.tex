...
% 1. \href{https://docs.opencv.org/4.x/da/df5/tutorial_py_sift_intro.html}{SIFT (Scale-Invariant Feature Transform)}

% 2. \href{https://machinelearningmastery.com/opencv_hog/}{HOG (Histogram of Oriented Gradients)}

% 3. \href{https://aihalapathirana.medium.com/understanding-the-local-binary-pattern-lbp-a-powerful-method-for-texture-analysis-in-computer-4fb55b3ed8b8}{Local Binary Pattern (LBP)}

% 4. \href{https://scikit-learn.org/1.5/modules/svm.html}{SVM (Support Vector Machine)}

% 5. \href{https://scikit-learn.org/1.5/modules/svm.html}{Random Forest}
